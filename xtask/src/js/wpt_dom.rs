...
pub enum WptDomSuite {
  /// Run the curated DOM + HTML + event-loop subset (defaults to `dom/**,domparsing/**,html/**,event*/**,observers/**,url/**`).
  Curated,
...
impl WptDomSuite {
  fn default_filter(self) -> Option<&'static str> {
    match self {
      ...
      Self::Curated => Some("dom/**,domparsing/**,html/**,event*/**,observers/**,url/**"),
