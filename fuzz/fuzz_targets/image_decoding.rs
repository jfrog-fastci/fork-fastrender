...
fuzz_target!(|data: &[u8]| {
  ...
  let config = ImageCacheConfig {
    ...
    max_cached_svg_preprocess_items: 16,
    max_cached_svg_preprocess_bytes: 2 * 1024 * 1024,
    max_cached_svg_subresource_items: 16,
    max_cached_svg_subresource_bytes: 8 * 1024 * 1024,
