//! Dedicated test target for focused multi-column layout regressions.
//!
//! The full integration suite is linked via `tests/integration.rs`. This target exists so automation
//! can run a small slice of multi-column assertions without executing the entire integration test
//! harness.
