...
#[test]
fn containment_table_intrinsic_inline_size_regression() {
  ...
  let html_path = fixtures_dir().join("containment_table_intrinsic_inline_size/index.html");
  let html =
  ...
  let golden_name = "containment_table_intrinsic_inline_size";
