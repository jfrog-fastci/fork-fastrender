...
FONT_DEFS = [
    ...
    {
        "source": "telugu",
        "output": "NotoSansTelugu-subset.ttf",
        "unicodes": [
            "U+0020-007E",
            "U+0300-036F",
            "U+0C00-0C7F",
    ...
    {
        "source": "javanese",
        "output": "NotoSansJavanese-subset.ttf",
        "unicodes": [
            "U+0020-007E",
            "U+0300-036F",
            "U+A980-A9DF",
    ...
    {
        "source": "thaana",
        "output": "NotoSansThaana-subset.ttf",
        "unicodes": [
            "U+0020-007E",
            "U+0300-036F",
            "U+0780-07BF",
    ...
    {
        "source": "syriac",
        "output": "NotoSansSyriac-subset.ttf",
        "unicodes": [
            "U+0020-007E",
            "U+0300-036F",
            "U+0700-074F",
