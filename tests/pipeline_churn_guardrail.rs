...
//! integration test binary (`tests/integration.rs`) executes hundreds of layout tests in parallel,
//! so keeping churn guardrails in the same process can introduce cross-test contention/flakiness.
//!
