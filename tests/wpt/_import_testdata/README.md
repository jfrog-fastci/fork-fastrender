...
- a set of network/url validation fixtures under `html/network/`:
  ...
  - `srcset-unquoted-external.html`: `srcset=https://example.com/...` rejection
  ...
  - `imagesrcset-unquoted.html`: `imagesrcset=...web-platform.test...` rewrite
  - `imagesrcset-unquoted-external.html`: `imagesrcset=https://example.com/...` rejection
