...
#[test]
fn flex_item_table_layout_fixed_width_auto_uses_auto_layout_collapsed_border_model() {
  let html = r#"
    <html>
      <head>
        <style>
  ...
  assert!(
    max_cell_width > 250.0,
    "expected wide second-row content to influence column width in flex collapsed model (max cell width {max_cell_width:.2})"
  );
}

#[test]
fn flex_item_table_layout_fixed_width_auto_uses_auto_layout_collapsed_border_model_rtl() {
  let html = r#"
    <html>
      <head>
        <style>
  ...
  assert!(
    max_cell_width > 250.0,
    "expected wide second-row content to influence column width in flex collapsed model RTL (max cell width {max_cell_width:.2})"
  );
