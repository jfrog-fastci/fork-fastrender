use fastrender::layout::float_context::{
  float_profile_stats, reset_float_profile_counters, FloatContext, FloatProfileOverrideGuard, FloatSide,
};

#[test]
fn float_range_queries_do_not_clone_sweep_state() {
  let _guard = FloatProfileOverrideGuard::new(true);
