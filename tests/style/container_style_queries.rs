...
#[test]
fn container_style_query_range_feature_matches_translate() {
  let html = r#"
    <style>
      .container-none { container-type: inline-size; translate: none; }
      .container-small { container-type: inline-size; translate: 1px; }
      .container-large { container-type: inline-size; translate: 3px; }
      .container-nonuniform { container-type: inline-size; translate: 3px 1px; }
      .child { color: rgb(0 0 255); }
      @container style(translate > 2px) {
        .child { color: rgb(255 0 0); }
      }
    </style>
    <div class="container-none">
...
#[test]
fn container_style_query_range_feature_matches_margin() {
  let html = r#"
    <style>
      .container-thin { container-type: inline-size; margin: 1px; }
      .container-thick { container-type: inline-size; margin: 3px; }
      .container-mixed { container-type: inline-size; margin: 3px 1px; }
      .child { color: rgb(0 0 255); }
...
#[test]
fn container_style_query_range_feature_matches_margin_inline_start() {
  let html = r#"
    <style>
      .container-thin { container-type: inline-size; margin-inline-start: 1px; }
      .container-ltr { container-type: inline-size; margin-inline-start: 3px; direction: ltr; }
      .container-rtl { container-type: inline-size; margin-inline-start: 3px; direction: rtl; }
      .child { color: rgb(0 0 255); }
      @container style(margin-inline-start > 2px) {
        .child { color: rgb(255 0 0); }
      }
    </style>
    <div class="container-thin">
...
#[test]
fn container_style_query_range_feature_matches_padding() {
  let html = r#"
    <style>
      .container-thin { container-type: inline-size; padding: 1px; }
      .container-thick { container-type: inline-size; padding: 3px; }
      .container-mixed { container-type: inline-size; padding: 3px 1px; }
      .child { color: rgb(0 0 255); }
...
#[test]
fn container_style_query_range_feature_matches_padding_block_start() {
  let html = r#"
    <style>
      .container-small { container-type: inline-size; padding-block-start: 1px; }
      .container-vertical { container-type: inline-size; writing-mode: vertical-rl; padding-block-start: 3px; }
      .child { color: rgb(0 0 255); }
      @container style(padding-block-start > 2px) {
        .child { color: rgb(255 0 0); }
      }
    </style>
    <div class="container-small">
...
fn container_style_query_range_feature_matches_border_spacing() {
  let html = r#"
    <style>
      .container-tight { container-type: inline-size; border-spacing: 1px; }
      .container-wide { container-type: inline-size; border-spacing: 3px; }
      .child { color: rgb(0 0 255); }
      @container style(border-spacing > 2px) {
        .child { color: rgb(255 0 0); }
      }
    </style>
    <div class="container-tight">
...
#[test]
fn container_style_query_range_feature_matches_row_gap() {
  let html = r#"
    <style>
      .container-tight { container-type: inline-size; row-gap: 10px; }
      .container-wide { container-type: inline-size; row-gap: 20px; }
      .child { color: rgb(0 0 255); }
      @container style(row-gap > 15px) {
        .child { color: rgb(255 0 0); }
      }
    </style>
    <div class="container-tight">
...
fn container_type_accepts_scroll_state_but_rejects_none_and_style_keywords() {
  let html = r#"
    <style>
      ...
      .invalid-dup-size { container-type: size size; }
      .invalid-mixed-size { container-type: size inline-size; }
      .invalid-mixed-normal { container-type: normal scroll-state; }
    ...
    <div id="invalid-dup-size" class="base invalid-dup-size"></div>
    <div id="invalid-mixed-size" class="base invalid-mixed-size"></div>
    <div id="invalid-mixed-normal" class="base invalid-mixed-normal"></div>
  ...
  let scroll_state_and_inline_size = find_by_id(&styled, "scroll-state-and-inline-size")
    .expect("scroll-state-and-inline-size element");
  assert_eq!(
    scroll_state_and_inline_size.styles.container_type,
  ...
  assert_eq!(
    shorthand_scroll_state.styles.container_type,
    ContainerType::ScrollState
  );
  assert_eq!(
  ...
  let shorthand_scroll_state_and_inline_size =
    find_by_id(&styled, "shorthand-scroll-state-and-inline-size")
      .expect("shorthand-scroll-state-and-inline-size element");
  assert_eq!(
    shorthand_scroll_state_and_inline_size.styles.container_type,
    ContainerType::InlineSizeScrollState
  );
  assert_eq!(
    shorthand_scroll_state_and_inline_size.styles.container_name,
    vec!["demo".to_string()]
  );
