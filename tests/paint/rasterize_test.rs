...
use fastrender::paint::rasterize::fill_rect;
use fastrender::paint::rasterize::fill_rounded_rect;
use fastrender::paint::rasterize::render_borders;
use fastrender::paint::rasterize::render_box_shadow;
use fastrender::paint::rasterize::stroke_rect;
use fastrender::paint::rasterize::stroke_rounded_rect;
