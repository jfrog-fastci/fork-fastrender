...
const HTML_PATH: &str = "tests/fixtures/html/text_decoration_skip_ink_rtl.html";
const GOLDEN_PATH: &str = "tests/fixtures/golden/text_decoration_skip_ink_rtl.png";
const DIFF_DIR: &str = "target/text_decoration_skip_ink_rtl_diffs";
const VIEWPORT: (u32, u32) = (520, 220);
...
#[test]
fn text_decoration_skip_ink_rtl_matches_golden() {
  let compare_config =
