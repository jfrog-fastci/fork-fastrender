use fastrender::paint::display_list::{DisplayItem, StackingContextItem, Transform3D};
...
fn perspective_property_matches_perspective_transform_function() {
  let html = include_str!("../wpt/tests/transforms/perspective-preserve-3d-001.html");
  let html_ref = include_str!("../wpt/tests/transforms/perspective-preserve-3d-001-ref.html");
