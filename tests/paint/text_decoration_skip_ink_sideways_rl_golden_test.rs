...
const HTML_PATH: &str = "tests/fixtures/html/text_decoration_skip_ink_sideways_rl.html";
const GOLDEN_PATH: &str = "tests/fixtures/golden/text_decoration_skip_ink_sideways_rl.png";
const DIFF_DIR: &str = "target/text_decoration_skip_ink_sideways_rl_diffs";
