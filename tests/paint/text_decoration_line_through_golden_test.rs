...
const HTML_PATH: &str = "tests/fixtures/html/text_decoration_line_through.html";
const GOLDEN_PATH: &str = "tests/fixtures/golden/text_decoration_line_through.png";
const DIFF_DIR: &str = "target/text_decoration_line_through_diffs";
const VIEWPORT: (u32, u32) = (400, 250);
...
#[test]
fn text_decoration_line_through_matches_golden() {
  let compare_config =
