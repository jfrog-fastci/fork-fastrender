...
vendor/ecma-rs/webidl-runtime/ — Legacy heap-only runtime adapter (Cargo package `webidl-runtime`; compat/migration only, re-exported as `fastrender::js::webidl::legacy`)
