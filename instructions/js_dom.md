...
vendor/ecma-rs/webidl-runtime/ — Legacy heap-only runtime adapter (Cargo package `webidl-js-runtime`; compat/migration only, re-exported as `fastrender::js::webidl::legacy`)
