...
vendor/ecma-rs/webidl-runtime/ — Legacy heap-only runtime adapter (Cargo package `webidl-runtime`; compat/migration only)

crates/webidl-js-runtime/      — Transitional (deprecated) workspace-local copy of the legacy runtime
