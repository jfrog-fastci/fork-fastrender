# WebIDL Stack Consolidation (post-migration)
...
If you need the legacy heap-only runtime (used by early scaffolding and some unit tests), it is a
vendored crate in `vendor/ecma-rs/webidl-runtime/`.
