...
- End-to-end (public API) tests are integration tests under `tests/` (see `tests/integration.rs`); browser/UI scenarios live in `tests/browser_integration/` and are included by that harness
