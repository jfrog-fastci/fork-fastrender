...
use native_js::ts_ir::{tailcall_regression_module_ir, TAILCALL_TEST_CALLEE, TAILCALL_TEST_CALLER};
use native_js::tail_calls::{
  assert_function_calls_symbol, assert_function_does_not_jump_to_symbol, assert_function_has_ret,
  assert_no_tail_call_jumps, assert_objdump_has_section,
};
