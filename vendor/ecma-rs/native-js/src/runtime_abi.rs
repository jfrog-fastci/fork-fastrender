...
pub struct RuntimeFns<'ctx> {
  ...
  pub rt_register_shape_table_extend: FunctionValue<'ctx>,
  pub rt_register_shape_table_append: FunctionValue<'ctx>,
  pub rt_register_shape: FunctionValue<'ctx>,
...
impl<'ctx, 'm> RuntimeAbi<'ctx, 'm> {
  ...
  pub fn declare_all(&self) -> RuntimeFns<'ctx> {
    ...
    RuntimeFns {
      ...
      rt_register_shape_table_extend: self.get_or_declare_raw(RuntimeFn::RegisterShapeTableExtend),
      rt_register_shape_table_append: self.get_or_declare_raw(RuntimeFn::RegisterShapeTableAppend),
      rt_register_shape: self.get_or_declare_raw(RuntimeFn::RegisterShape),
