...
Functions generated by the inkwell-based backends are also marked with the LLVM
GC strategy attribute (`gc "coreclr"`). See [`docs/llvm_gc_strategy.md`](./docs/llvm_gc_strategy.md)
for the rationale and how to change it.
