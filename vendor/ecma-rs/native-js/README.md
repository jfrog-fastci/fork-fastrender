...
> initialization ordering, and imports can resolve through re-export-only modules.
>
> The entry file must export `main()`, but it may be re-exported (e.g. `export { main } from "./impl"`).
>
