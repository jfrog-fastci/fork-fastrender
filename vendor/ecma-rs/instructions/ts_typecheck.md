# TypeScript Type Checking for ecma-rs (from-scratch "ideal" design)
...
├── semantic-js/               # new: unified, deterministic semantics (scopes/symbols/modules/exports); only semantics layer (symbol-js removed)
