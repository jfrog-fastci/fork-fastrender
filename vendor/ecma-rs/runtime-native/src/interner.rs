...
///
/// This matches the design goal in `instructions/native_aot.md` (§5.3; historically `EXEC.plan.md`):
/// pin common strings (keywords/property names) permanently, but allow opportunistic reclamation of
/// unused interned strings.
