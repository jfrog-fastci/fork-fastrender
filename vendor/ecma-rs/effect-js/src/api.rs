...
impl ApiId {
  pub fn as_str(self) -> &'static str {
    match self {
      ...
      ApiId::MapPrototypeSize => "Map.prototype.size",
      ApiId::SetPrototypeSize => "Set.prototype.size",
      ApiId::Fetch => "fetch",
  ...
  pub fn from_kb_name(name: &str) -> Option<Self> {
    Some(match name {
      ...
      "Map.prototype.size" => ApiId::MapPrototypeSize,
      "Set.prototype.size" => ApiId::SetPrototypeSize,
      "fetch" => ApiId::Fetch,
