...
#[test]
fn generator_computed_member_compound_assignment_roots_key_across_gc() -> Result<(), VmError> {
  ...
  // - The compound assignment (`**=`) then evaluates the RHS in a continuation frame (`AssignAddAfterRhs`).
