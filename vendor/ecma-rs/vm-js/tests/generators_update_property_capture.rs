...
#[test]
fn generator_decrement_computed_member_evaluates_base_key_and_old_value_once_across_yield_postfix() {
  let mut rt = new_runtime();
  let value = rt
    .exec_script(
      r#"
...
#[test]
fn generator_decrement_computed_member_evaluates_base_key_and_old_value_once_across_yield_prefix() {
  let mut rt = new_runtime();
  let value = rt
    .exec_script(
      r#"
