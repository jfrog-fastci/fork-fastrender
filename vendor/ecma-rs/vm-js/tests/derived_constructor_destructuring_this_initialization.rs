...
#[test]
fn derived_constructor_body_let_destructuring_default_this_throws_reference_error() {
  let mut rt = new_runtime();
  let value = rt
    .exec_script(
      r#"
...
#[test]
fn derived_constructor_body_let_destructuring_default_this_throws_reference_error_compiled(
) -> Result<(), VmError> {
  let mut rt = new_runtime();
  let value = exec_compiled(
    &mut rt,
...
#[test]
fn derived_constructor_body_let_destructuring_default_super_property_throws_reference_error() {
  let mut rt = new_runtime();
  let value = rt
    .exec_script(
      r#"
...
#[test]
fn derived_constructor_body_let_destructuring_default_super_property_throws_reference_error_compiled(
) -> Result<(), VmError> {
  let mut rt = new_runtime();
  let value = exec_compiled(
    &mut rt,
...
#[test]
fn derived_constructor_body_let_destructuring_computed_key_super_computed_does_not_run() {
  let mut rt = new_runtime();
  let value = rt
    .exec_script(
      r#"
...
#[test]
fn derived_constructor_body_let_destructuring_computed_key_super_computed_does_not_run_compiled(
) -> Result<(), VmError> {
  let mut rt = new_runtime();
  let value = exec_compiled(
    &mut rt,
