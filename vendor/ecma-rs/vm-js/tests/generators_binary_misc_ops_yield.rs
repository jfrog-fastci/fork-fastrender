...
#[test]
fn bigint_bitwise_and_with_yield_in_both_operands() {
  let mut rt = new_runtime();
  let value = rt
    .exec_script(
      r#"
...
#[test]
fn bigint_bitwise_xor_with_yield_in_both_operands() {
  let mut rt = new_runtime();
  let value = rt
    .exec_script(
      r#"
...
#[test]
fn bigint_left_shift_with_yield_in_both_operands() {
  let mut rt = new_runtime();
  let value = rt
    .exec_script(
      r#"
...
#[test]
fn bigint_right_shift_with_yield_in_both_operands() {
  let mut rt = new_runtime();
  let value = rt
    .exec_script(
      r#"
...
#[test]
fn bigint_bitwise_and_mixing_error_is_catchable_under_yield() {
  let mut rt = new_runtime();
  let value = rt
    .exec_script(
      r#"
