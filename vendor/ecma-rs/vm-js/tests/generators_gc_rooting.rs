...
#[test]
fn generator_resume_roots_yield_star_iterator_record_values() {
  let mut rt = new_runtime_gc();
  rt
    .exec_script(&format!(
      r#"
...
#[test]
fn generator_resume_roots_object_literal_after_computed_key_yield() {
  let mut rt = new_runtime_gc();
  rt
    .exec_script(&format!(
      r#"
...
#[test]
fn generator_resume_roots_object_literal_after_prop_value_yield() {
  let mut rt = new_runtime_gc();
  rt
    .exec_script(&format!(
      r#"
