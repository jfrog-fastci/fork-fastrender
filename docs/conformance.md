...
| Style | Conditional eval | ⚠️ | [src/style/media.rs](../src/style/media.rs)<br>[src/style/cascade.rs](../src/style/cascade.rs) | [tests/style/media_test.rs](../tests/style/media_test.rs)<br>[tests/style/supports_rule_test.rs](../tests/style/supports_rule_test.rs)<br>[tests/wpt/tests/style/conditional/](../tests/wpt/tests/style/conditional/)<br>[tests/wpt/tests/style/container_queries/](../tests/wpt/tests/style/container_queries/) | @media MQ4 features, @supports, size-only container queries; container type `size`/`inline-size` resolved from ancestor styles. |
...
| Paint | Text & decorations | ⚠️ | [src/paint/text_rasterize.rs](../src/paint/text_rasterize.rs)<br>[src/paint/text_shadow.rs](../src/paint/text_shadow.rs)<br>[src/paint/display_list_renderer.rs](../src/paint/display_list_renderer.rs) | [tests/paint/text_rasterize_test.rs](../tests/paint/text_rasterize_test.rs)<br>[tests/paint/color_bitmap_glyph_test.rs](../tests/paint/color_bitmap_glyph_test.rs)<br>[tests/colr_v1_color_font_test.rs](../tests/colr_v1_color_font_test.rs)<br>[tests/colr_v1_sweep_gradient_test.rs](../tests/colr_v1_sweep_gradient_test.rs) | Text shadows, underline/overline/line-through with offsets/decoration thickness, emphasis marks, ruby annotations painted inline. Color glyphs: [`TextRasterizer`](../src/paint/text_rasterize.rs) (also used by display-list/`Canvas`) renders embedded bitmaps (CBDT/CBLC + sbix, PNG/JPEG), SVG-in-OT, COLR/CPAL v0, and COLR v1 paint graphs (solids, linear/radial/sweep gradients, transforms, composite modes) via [`text/color_fonts`](../src/text/color_fonts/mod.rs). Palette selection is carried as `palette_index`; `@font-palette-values` override-colors are honoured when provided to `TextRasterizer` but are not yet stored in display-list text items. See [notes/color-fonts.md](notes/color-fonts.md). |
| Text | Shaping pipeline | ⚠️ | [src/text/pipeline.rs](../src/text/pipeline.rs) | [tests/text/pipeline_test.rs](../tests/text/pipeline_test.rs)<br>[tests/text/font_palette_test.rs](../tests/text/font_palette_test.rs) | UAX #9 bidi, script itemization, RustyBuzz shaping with OpenType features/variations. Shaped runs carry a resolved CPAL `palette_index` plus `@font-palette-values` override-colors (resolved against currentColor) for use by the color-glyph rasterizers (bitmap/SVG/COLR v0/v1) in [`text/color_fonts`](../src/text/color_fonts/mod.rs). Display-list text currently forwards `palette_index` only. See [notes/color-fonts.md](notes/color-fonts.md). |
