...
use windows_sys::Win32::Foundation::{
    HANDLE, WAIT_OBJECT_0, WAIT_TIMEOUT, ERROR_INSUFFICIENT_BUFFER,
};
use windows_sys::Win32::Security::SECURITY_CAPABILITIES;
use windows_sys::Win32::System::Threading::{
    CreateProcessW, DeleteProcThreadAttributeList, GetExitCodeProcess,
    InitializeProcThreadAttributeList, TerminateProcess, UpdateProcThreadAttribute,
    WaitForSingleObject, LPPROC_THREAD_ATTRIBUTE_LIST, PROCESS_INFORMATION, STARTUPINFOEXW,
    STARTUPINFOW, CREATE_UNICODE_ENVIRONMENT, EXTENDED_STARTUPINFO_PRESENT, INFINITE,
...
pub fn spawn_sandboxed(cfg: &SpawnConfig<'_>) -> std::result::Result<ChildProcess, WinSandboxError> {
