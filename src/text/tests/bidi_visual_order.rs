...
fn default_style() -> Arc<crate::ComputedStyle> {
...
fn bidi_visual_order_handles_mixed_arabic_ltr() {
  ...
  let mut rtl_style = crate::ComputedStyle::default();
...
fn bidi_isolate_keeps_neutral_brackets_outside() {
  ...
  let mut rtl_isolate = crate::ComputedStyle::default();
...
fn bidi_isolate_override_keeps_neutral_brackets_outside() {
  ...
  let mut rtl_iso_override = crate::ComputedStyle::default();
...
fn bidi_embed_allows_neutral_reordering() {
  let mut rtl_embed = crate::ComputedStyle::default();
...
fn bidi_override_reorders_inline_children() {
  let mut rtl_override = crate::ComputedStyle::default();
