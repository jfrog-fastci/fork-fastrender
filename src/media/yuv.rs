...
//!
//! This module is a thin re-export wrapper around the workspace-level `fastrender-yuv` crate so
//! both the main `fastrender` crate and auxiliary codec crates (e.g. `libvpx-sys-bundled`) can share
//! identical pixel conversion logic without dependency cycles.

pub use fastrender_yuv::yuv420p_to_rgba;
