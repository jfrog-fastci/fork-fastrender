...
#[test]
fn container_style_query_container_units_with_unknown_block_size_do_not_match() {
  let css = r#"
    .target { display: block; }
    @container style(font-size > 1cqb) {
      .target { display: inline; }
    }
  "#;
...
#[test]
fn container_style_query_cqmin_with_unknown_block_size_do_not_match() {
  let css = r#"
    .target { display: block; }
    @container style(font-size > 1cqmin) {
      .target { display: inline; }
    }
  "#;
...
#[test]
fn container_style_query_zero_cqmax_with_unknown_block_size_matches() {
  let css = r#"
    .target { display: block; }
    @container style(font-size > 0cqmax) {
      .target { display: inline; }
    }
  "#;
...
fn not_container_style_query_with_unknown_block_size_does_not_match() {
  let css = r#"
    .target { display: block; }
    @container not style(font-size < 1cqb) {
      .target { display: inline; }
    }
  "#;
...
#[test]
fn container_style_query_plain_container_units_with_unknown_block_size_do_not_match() {
  let css = r#"
    .target { display: block; }
    @container style(margin-left: 1cqb) {
      .target { display: inline; }
    }
  "#;
...
#[test]
fn container_style_query_plain_calc_cancellation_with_unknown_block_size_matches() {
  let css = r#"
    .target { display: block; }
    @container style(margin-left: calc(1cqb - 1cqb)) {
      .target { display: inline; }
    }
  "#;
...
#[test]
fn container_style_query_plain_cqmin_with_unknown_block_size_do_not_match() {
  let css = r#"
    .target { display: block; }
    @container style(margin-left: 1cqmin) {
      .target { display: inline; }
    }
  "#;
...
#[test]
fn not_container_style_query_plain_with_unknown_block_size_does_not_match() {
  let css = r#"
    .target { display: block; }
    @container not style(margin-left: 1cqb) {
      .target { display: inline; }
    }
  "#;
...
#[test]
fn not_container_style_query_transform_container_units_with_unknown_block_size_does_not_match() {
  let css = r#"
    .target { display: block; }
    @container not style(transform: translateX(1cqb)) {
      .target { display: inline; }
    }
  "#;
...
#[test]
fn not_container_style_query_box_shadow_container_units_with_unknown_block_size_does_not_match() {
  let css = r#"
    .target { display: block; }
    @container not style(box-shadow: 0 0 1cqb 0 black) {
      .target { display: inline; }
    }
  "#;
...
#[test]
fn container_query_container_units_with_unknown_block_size_do_not_match() {
  let css = r#"
    .target { display: block; }
    @container (min-width: 1cqb) {
      .target { display: inline; }
    }
  "#;
...
#[test]
fn container_query_zero_cqmax_with_unknown_block_size_matches() {
  let css = r#"
    .target { display: block; }
    @container (min-width: 0cqmax) {
      .target { display: inline; }
    }
  "#;
...
#[test]
fn container_query_resolves_lh_inside_calc_in_size_features() {
  let css = r#"
    .target { display: block; }
    @container (min-width: calc(4lh - 1px)) {
      .target { display: inline; }
    }
  "#;
  ...
  // `calc(4lh - 1px)` should resolve `lh` using the container's computed line-height. With
