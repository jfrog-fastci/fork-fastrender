...
pub(crate) fn inline_axis_positive(wm: WritingMode, dir: Direction) -> bool {
  ...
  match wm {
    WritingMode::SidewaysLr => dir == Direction::Rtl,
    _ => dir != Direction::Rtl,
  }
}
...
pub struct LogicalState {
  ...
  pub outline_color_order: i32,
  pub outline_style_order: i32,
  pub outline_width_order: i32,
  pub box_sizing_order: i32,
  ...
  pub background_color_order: i32,
...
impl Default for LogicalState {
  fn default() -> Self {
    Self {
      ...
      outline_color_order: -1,
      outline_style_order: -1,
      outline_width_order: -1,
      box_sizing_order: -1,
...
pub struct ComputedStyle {
  ...
  pub svg_clip_rule: Option<FillRule>,
  ...
  pub svg_stop_color: Option<Rgba>,
  pub svg_stop_opacity: Option<f32>,
