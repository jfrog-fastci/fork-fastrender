...
use crate::{FastRender, FastRenderConfig, FontConfig, FontContext, Size};
...
fn find_text_fragment_pos(fragment: &crate::FragmentNode, needle: &str) -> Option<(f32, f32)> {
  fn walk(node: &crate::FragmentNode, origin: (f32, f32), needle: &str) -> Option<(f32, f32)> {
