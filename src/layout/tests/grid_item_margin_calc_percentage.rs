...
#[test]
fn grid_item_margin_left_calc_percentage_resolves_against_grid_area_width() {
  ...
  child_style.width = Some(Length::px(0.0));
  child_style.margin_left = Some(calc(10.0, 5.0));
