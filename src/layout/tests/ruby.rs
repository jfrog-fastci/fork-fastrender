...
fn baseline_for_text(fragment: &crate::FragmentNode, needle: &str) -> Option<f32> {
...
fn span_for_text(root: &crate::FragmentNode, needle: &str) -> Option<(f32, f32)> {
...
fn span_for_text_x(root: &crate::FragmentNode, needle: &str) -> Option<(f32, f32)> {
  let mut spans = Vec::new();
...
fn count_lines(fragment: &crate::FragmentNode) -> usize {
