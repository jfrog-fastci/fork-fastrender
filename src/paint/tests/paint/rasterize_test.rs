...
use crate::paint::rasterize::draw_line;
use crate::paint::rasterize::fill_circle;
use crate::paint::rasterize::fill_ellipse;
use crate::paint::rasterize::fill_rect;
use crate::paint::rasterize::fill_rounded_rect;
use crate::paint::rasterize::render_borders;
use crate::paint::rasterize::render_box_shadow;
use crate::paint::rasterize::stroke_rect;
use crate::paint::rasterize::stroke_rounded_rect;
use crate::paint::rasterize::BorderColors;
use crate::paint::rasterize::BorderWidths;
...
mod rounded_rect_tests {
  ...
  fn test_stroke_rounded_rect() {
    let mut pixmap = create_pixmap(100, 100);
    let radii = BorderRadii::uniform(10.0);
    let result = stroke_rounded_rect(
      &mut pixmap,
      10.0,
      10.0,
      60.0,
