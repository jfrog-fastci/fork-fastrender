...
fn overflow_clip_margin_expands_clip_area(renderer: &mut crate::FastRender) {
  let html = r#"
  <style>
...
fn overflow_clip_margin_preserves_rounded_corners(renderer: &mut crate::FastRender) {
  let html = r#"
  <style>
    body { margin: 0; background: white; }
    #outer {
