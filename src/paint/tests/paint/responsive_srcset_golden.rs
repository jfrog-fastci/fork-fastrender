...
const HTML_PATH: &str = "tests/fixtures/html/responsive_srcset.html";
const GOLDEN_DIR: &str = "tests/fixtures/golden";
const DIFF_DIR: &str = "target/responsive_diffs";
const VIEWPORT: (u32, u32) = (32, 32);

fn should_update_golden() -> bool {
  std::env::var("UPDATE_RESPONSIVE_GOLDEN").is_ok()
}
...
#[test]
fn responsive_srcset_golden_across_dpr() {
  let compare_config =
  ...
  let outputs = [
    (1.0_f32, "responsive_srcset.png"),
    (2.0_f32, "responsive_srcset_dpr2.png"),
  ];
