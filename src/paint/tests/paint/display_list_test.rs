...
use crate::paint::display_list::BorderRadius as DisplayBorderRadius;
...
use crate::FillRectItem;
use crate::FillRoundedRectItem;
use crate::FontContext;
use crate::GlyphInstance;
use crate::GradientSpread;
use crate::GradientStop;
use crate::ImageData;
use crate::ImageFilterQuality;
use crate::ImageItem;
use crate::LinearGradientItem;
use crate::OpacityItem;
use crate::PaintTextItem as TextItem;
use crate::RadialGradientItem;
use crate::Rgba;
use crate::StrokeRectItem;
use crate::StrokeRoundedRectItem;
use crate::Transform2D;
use crate::Transform3D;
use crate::TransformItem;
use std::sync::Arc;
...
fn fragment_background_emits_fill() {
  ...
  let list = crate::paint::display_list_builder::DisplayListBuilder::new()
...
fn fragment_uniform_border_emits_stroke() {
  let mut style = crate::ComputedStyle::default();
  style.border_top_width = crate::style::values::Length::px(2.0);
  style.border_right_width = crate::style::values::Length::px(2.0);
  style.border_bottom_width = crate::style::values::Length::px(2.0);
  style.border_left_width = crate::style::values::Length::px(2.0);
  style.border_top_style = crate::style::types::BorderStyle::Solid;
  style.border_right_style = crate::style::types::BorderStyle::Solid;
  style.border_bottom_style = crate::style::types::BorderStyle::Solid;
...
fn fragment_mixed_borders_emit_border_item() {
  let mut style = crate::ComputedStyle::default();
  style.border_top_width = crate::style::values::Length::px(1.0);
  style.border_right_width = crate::style::values::Length::px(2.0);
  style.border_bottom_width = crate::style::values::Length::px(0.0);
  style.border_left_width = crate::style::values::Length::px(3.0);
...
fn background_attachment_local_clips_to_padding_box_in_display_list() {
  ...
  style.overflow_x = crate::style::types::Overflow::Scroll;
  style.overflow_y = crate::style::types::Overflow::Scroll;
...
fn display_list_background_layers_use_per_layer_clip() {
  let mut style = crate::ComputedStyle::default();
  style.background_color = Rgba::TRANSPARENT;
  style.padding_left = crate::style::values::Length::px(4.0);
  style.padding_right = crate::style::values::Length::px(4.0);
  style.padding_top = crate::style::values::Length::px(4.0);
  style.padding_bottom = crate::style::values::Length::px(4.0);
...
fn background_repeat_space_centers_single_tile_in_display_list() {
  ...
  style.set_background_layers(vec![BackgroundLayer {
    ...
    repeat: BackgroundRepeat {
      x: crate::style::types::BackgroundRepeatKeyword::Space,
      y: crate::style::types::BackgroundRepeatKeyword::Space,
    },
    size: crate::style::types::BackgroundSize::Explicit(
      crate::style::types::BackgroundSizeComponent::Length(Length::px(30.0)),
      crate::style::types::BackgroundSizeComponent::Length(Length::px(30.0)),
    ),
    ..Default::default()
  }]);
...
fn background_attachment_fixed_anchors_to_viewport() {
  ...
  style.set_background_layers(vec![BackgroundLayer {
    ...
    repeat: BackgroundRepeat::no_repeat(),
    size: crate::style::types::BackgroundSize::Explicit(
      crate::style::types::BackgroundSizeComponent::Length(Length::px(10.0)),
      crate::style::types::BackgroundSizeComponent::Length(Length::px(10.0)),
    ),
    ..Default::default()
  }]);
...
fn fragment_box_shadow_emits_items() {
  ...
  style.box_shadow = vec![
    BoxShadow {
      ...
      offset_y: crate::style::values::Length::px(3.0),
      blur_radius: crate::style::values::Length::px(4.0),
      spread_radius: crate::style::values::Length::px(1.0),
      color: Rgba::BLACK,
      inset: false,
    },
    BoxShadow {
      offset_x: crate::style::values::Length::px(-1.0),
      offset_y: crate::style::values::Length::px(-2.0),
      blur_radius: crate::style::values::Length::px(0.0),
      spread_radius: crate::style::values::Length::px(0.0),
      color: Rgba::RED,
      inset: true,
    },
  ];
...
fn fragment_opacity_wraps_display_items() {
  ...
  let fragment = crate::FragmentNode::new_text_styled(
    Rect::from_xywh(0.0, 0.0, 20.0, 10.0),
    "hi".to_string(),
    8.0,
    Arc::new(style),
