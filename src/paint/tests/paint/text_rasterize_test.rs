...
fn get_test_font() -> Option<crate::text::font_db::LoadedFont> {
  let ctx = FontContext::new();
  ctx.get_sans_serif()
}

const VAR_FONT: &[u8] =
  include_bytes!(concat!(env!("CARGO_MANIFEST_DIR"), "/tests/fixtures/fonts/AmstelvarAlpha-VF.ttf"));
...
fn renders_rotated_runs_for_vertical_text() {
  ...
  style.writing_mode = crate::style::types::WritingMode::HorizontalTb;
...
fn test_vertical_rendering_extents() {
  ...
  vertical_style.writing_mode = crate::style::types::WritingMode::VerticalRl;
  vertical_style.text_orientation = crate::style::types::TextOrientation::Upright;
