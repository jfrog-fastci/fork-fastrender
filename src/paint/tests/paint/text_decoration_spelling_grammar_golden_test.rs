...
const HTML_PATH: &str = "tests/fixtures/html/text_decoration_spelling_grammar.html";
const GOLDEN_PATH: &str = "tests/fixtures/golden/text_decoration_spelling_grammar.png";
const DIFF_DIR: &str = "target/text_decoration_spelling_grammar_diffs";
const VIEWPORT: (u32, u32) = (640, 340);
...
#[test]
fn text_decoration_spelling_grammar_matches_golden() {
  let compare_config =
