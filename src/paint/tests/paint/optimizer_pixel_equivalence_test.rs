...
use crate::DisplayListOptimizer;
use crate::{BorderRadii, FontConfig, Length, Rgba};
use std::sync::OnceLock;
use tiny_skia::Pixmap;

fn shared_font_ctx() -> crate::text::font_loader::FontContext {
  static FONT_CTX: OnceLock<crate::text::font_loader::FontContext> = OnceLock::new();
  FONT_CTX
    .get_or_init(|| {
      crate::text::font_loader::FontContext::with_config(FontConfig::bundled_only())
    })
    .clone()
}
