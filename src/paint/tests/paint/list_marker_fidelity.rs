...
fn list_marker_builder_preserves_run_metadata() {
  ...
  let style = Arc::new(crate::ComputedStyle::default());
  let fragment = crate::tree::fragment_tree::FragmentNode::new_with_style(
    crate::geometry::Rect::from_xywh(0.0, 0.0, 100.0, 100.0),
  ...
  let list = crate::paint::display_list_builder::DisplayListBuilder::new().build(&fragment);
  let marker = list
    .items()
    .iter()
