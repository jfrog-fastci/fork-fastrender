...
const HTML_PATH: &str = "tests/fixtures/html/text_decoration_skip_ink_variable_font.html";
const GOLDEN_PATH: &str = "tests/fixtures/golden/text_decoration_skip_ink_variable_font.png";
const DIFF_DIR: &str = "target/text_decoration_skip_ink_variable_font_diffs";
const VIEWPORT: (u32, u32) = (460, 400);
...
#[test]
fn text_decoration_skip_ink_variable_font_matches_golden() {
  let compare_config =
