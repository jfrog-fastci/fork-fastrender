...
use crate::js::error_reporting::{dispatch_window_error_event, resolve_error_event_location};
...
use vm_js::{
  ...
  PromiseState, PropertyDescriptor, PropertyKey, PropertyKind, RealmId, RootId, Scope,
...
pub(crate) fn queue_uncaught_error_event_task<Host: WindowRealmHost + 'static>(
  ...
  event_loop.queue_task(TaskSource::DOMManipulation, move |host, event_loop| {
    ...
    let canceled = match dispatch_result {
