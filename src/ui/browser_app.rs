...
pub struct ChromeState {
  ...
  ///
  /// The windowed `browser` front-end owns the downloads panel UI and updates this flag. The chrome
  /// layer uses it to expose the expanded/collapsed state to AccessKit (screen readers).
