//! Browser-UI specific safety limits for viewport/DPR.
//!
...
//! multi-gigabyte RGBA pixmaps from the worker.
//!
//! This module provides deterministic clamping that is shared between the UI thread and the worker
//! thread so:
